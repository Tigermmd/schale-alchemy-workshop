...
assert.match(css, /\.agent-chat-window \.agent-chat\s*\{[\s\S]*assets\/ui\/agent-schale-office\.png/, "chat conversation should use a high-resolution Schale visual");
assert.match(css, /\.agent-chat-window \.agent-chat\s*\{[\s\S]*rgba\(251, 253, 254, \.38\)/, "Schale visual should fade into a readable conversation surface");
