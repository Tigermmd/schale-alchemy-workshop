...
import { calculateRequiredRelationshipExp } from "./planner-state.js?v=dashboard-20260814-rebuild-v43";
import { summarizeUnlimitedAssaultRewards } from "./resource-model.js?v=dashboard-20260814-rebuild-v43";
