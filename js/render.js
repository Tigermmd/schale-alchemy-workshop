import { boostedGiftGroups, giftValuesForFilter } from "./dashboard-state.js?v=dashboard-20260817-gift-clean-v55";
import {
  localizedName,
  localizedReactionLabel,
  localeTag,
  text as t,
} from "./i18n.js?v=dashboard-20260817-gift-clean-v55";
