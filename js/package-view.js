import { calculatePackageEfficiency } from "./planning-summary.js?v=dashboard-20260818-relationship-brand-avatar-v98";
import { resolveStudentFavoriteGiftId } from "./gift-only-planner.js?v=dashboard-20260818-relationship-brand-avatar-v98";
import { localizedName, text as t } from "./i18n.js?v=dashboard-20260818-relationship-brand-avatar-v98";
import { formatExp, formatInteger, formatQuantity } from "./render.js?v=dashboard-20260818-relationship-brand-avatar-v98";
