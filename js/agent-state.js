import { addStudentPlan, normalizePlannerState } from "./planner-state.js?v=dashboard-20260817-gift-clean-v63";
import { calculateRelationshipSourceForecast, getEligibleRelationshipSources, getStudentReleaseStatus, normalizeCnProgress } from "./release-state.js?v=dashboard-20260817-gift-clean-v63";
import { calculateGiftOnlyForecast } from "./gift-only-planner.js?v=dashboard-20260817-gift-clean-v63";
import { calculatePackageEfficiency, calculatePlanningSummary } from "./planning-summary.js?v=dashboard-20260817-gift-clean-v63";
import { text as t } from "./i18n.js?v=dashboard-20260817-gift-clean-v63";
