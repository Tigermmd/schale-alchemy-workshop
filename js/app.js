import { loadDashboardData } from "./data-loader.js?v=dashboard-20260817-gift-clean-v62";
import { filterStudents, getCraftingMechanismSummary, readSelectedStudentId, writeSelectedStudentId } from "./dashboard-state.js?v=dashboard-20260817-gift-clean-v62";
import { LANGUAGE_OPTIONS, localeTag, localizedName, readStoredLocale, text as t, writeStoredLocale } from "./i18n.js?v=dashboard-20260817-gift-clean-v62";
import { addStudentPlan, normalizePlannerState, parseStudentIdInput, readPlannerState, removeStudentPlan, setGiftBoxCount, setInventoryCount, setMainTargetStudent, setResourceAmount, writePlannerState } from "./planner-state.js?v=dashboard-20260817-gift-clean-v62";
import { confirmGiftReservations, migrateLegacyAutoPostedPackageContents, postPeriodicResource, releaseGiftReservations, reserveGiftAllocation, setEquivalentGiftPoolCount, setStockResourceCount, syncPurchasedPackagesToInventory, synthesizeGoldGift, undoPeriodicResource } from "./inventory-state.js?v=dashboard-20260817-gift-clean-v62";
import { applyInventoryImport, parseInventoryImport, serializeInventoryExport } from "./inventory-transfer.js?v=dashboard-20260817-gift-clean-v62";
import { prepareAllocation, renderPlannerStudentOptions, renderPlannerWorkspace, renderWorkbenchTabs, wirePlannerImageFallbacks } from "./planner-view.js?v=dashboard-20260817-gift-clean-v62";
import { refreshInventoryGiftRows, renderInventoryWorkspace, wireInventoryImageFallbacks } from "./inventory-view.js?v=dashboard-20260817-gift-clean-v62";
import { renderResourcesWorkspace } from "./resource-view.js?v=dashboard-20260817-gift-clean-v62";
import { renderPackagesWorkspace } from "./package-view.js?v=dashboard-20260817-gift-clean-v62";
import { renderStudentDetails, renderStudentList, wireImageFallbacks } from "./render.js?v=dashboard-20260817-gift-clean-v62";
import { buildAgentContext, applyPlanningProposal, canReuseConfiguredProxy, validatePlanningProposal } from "./agent-state.js?v=dashboard-20260817-gift-clean-v62";
import { renderAgentWorkspace } from "./agent-view.js?v=dashboard-20260817-gift-clean-v62";
import { getDefaultCnProgress, normalizeCnProgress } from "./release-state.js?v=dashboard-20260817-gift-clean-v62";
import { getWorkbenchChromeState, updateInventoryFilter } from "./workbench-state.js?v=dashboard-20260817-gift-clean-v62";
