...
import { LANGUAGE_OPTIONS, localeTag, localizedName, readStoredLocale, text as t, writeStoredLocale } from "./i18n.js?v=dashboard-20260819-schale-alchemy-workshop-agent-chat-v111&ui=v113&knowledge=v1";
...
import { prepareAllocation, renderPlannerStudentOptions, renderPlannerWorkspace, renderWorkbenchTabs, wirePlannerImageFallbacks } from "./planner-view.js?v=dashboard-20260819-schale-alchemy-workshop-agent-chat-v111&knowledge=v1";
...
import { renderKnowledgeWorkspace } from "./knowledge-view.js?v=dashboard-20260819-schale-alchemy-workshop-agent-chat-v111&knowledge=v1";
...
import { getWorkbenchChromeState, updateInventoryFilter } from "./workbench-state.js?v=dashboard-20260819-schale-alchemy-workshop-agent-chat-v111&knowledge=v1";
