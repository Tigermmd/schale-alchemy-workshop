import { FUTURE_STUDENTS } from "./future-students.js?v=dashboard-20260814-rebuild-v45";
import { buildReleaseTimeline } from "./release-state.js?v=dashboard-20260814-rebuild-v45";
import { getCnGiftPackageCatalog } from "./package-catalog.js?v=dashboard-20260814-rebuild-v45";

const DATA_ROOT = "../relationship_data";

export const DATA_PATHS = Object.freeze({
  gifts: `${DATA_ROOT}/gifts.json?v=dashboard-20260814-rebuild-v45`,
  preferences: `${DATA_ROOT}/student_gift_preferences.json?v=dashboard-20260814-rebuild-v45`,
  crafting: `${DATA_ROOT}/crafting_expected_relationship.json?v=dashboard-20260814-rebuild-v45`,
  thresholds: `${DATA_ROOT}/relationship_thresholds.json?v=dashboard-20260814-rebuild-v45`,
  packages: `${DATA_ROOT}/paid_packages_cn.json?v=dashboard-20260814-rebuild-v45`,
  giftBoxes: `${DATA_ROOT}/gift_boxes_cn.json?v=dashboard-20260814-rebuild-v45`,
  unlimitedAssaultRewards: `${DATA_ROOT}/unlimited_assault_rewards_cn.json?v=dashboard-20260814-rebuild-v45`,
  resourceEvidence: `${DATA_ROOT}/resource_evidence_cn.json?v=dashboard-20260814-rebuild-v45`,
  localization: `${DATA_ROOT}/localization.json?v=dashboard-20260814-rebuild-v45`,
  releaseTimeline: `${DATA_ROOT}/jp_release_timeline.json?v=dashboard-20260814-rebuild-v45`,
});
...
export async function loadDashboardData() {
  const [giftSnapshot, preferenceSnapshot, craftingSnapshot, thresholdSnapshot, packageSnapshot, giftBoxSnapshot, unlimitedAssaultRewards, resourceEvidence, localization, releaseTimelineSnapshot, assetManifest] = await Promise.all([
    ...
    fetchOptionalJson("./assets/manifest.json?v=dashboard-20260814-rebuild-v45"),
  ]);
